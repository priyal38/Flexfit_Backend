...
const getFilterData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categories = yield workoutModel_1.default.distinct('category');
        const subcategories = yield workoutModel_1.default.distinct('subCategory');
        const difficultyLevels = yield workoutModel_1.default.distinct('difficultyLevel');
