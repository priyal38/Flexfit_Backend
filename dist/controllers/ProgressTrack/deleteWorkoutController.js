...
const deleteTableData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user;
        const workoutId = req.params.id;
        const deletedWorkout = yield userWorkoutModel_1.default.findByIdAndDelete(workoutId);
        if (!deletedWorkout) {
...
exports.default = deleteTableData;
